...
import name.yumao.ffxiv.boot.util.Language;
...
public class ConfigApplicationPanel extends JFrame implements ActionListener {
    ...
    private static String title = "提莫苑|启动设置";
    ...
    private JLabel dxModeLable = new JLabel("启动版本");
    ...
    public ConfigApplicationPanel(){
        ...
        setBounds((dimension.width-290)/2, (dimension.height-130)/2, 290, 160);
        setResizable(false);
        setLayout(null);
        //标题栏
        ...
        add(titlePanel);
        bodyPanel.setBounds(0, 0, 290, 160);
        ...
        langLableVal.addItem("日语");
        langLableVal.addItem("英语");
        langLableVal.addItem("德语");
        langLableVal.addItem("法语");
        ...
        dxModeLable.setBounds(30, 100, 100, 25);
        dxModeLable.setFont(new Font("Microsoft Yahei",Font.BOLD,13));
        dxModeLable.setForeground(new Color(110,110,110));
        add(dxModeLable,0);
        dxModeVal = new JComboBox<String>();
        dxModeVal.addItem("DX11");
        dxModeVal.addItem("DX9");
        dxModeVal.setBounds(100, 100, 160, 23);
        dxModeVal.setFont(new Font("Microsoft Yahei",Font.BOLD,13));
        dxModeVal.setForeground(new Color(110,110,110));
        dxModeVal.setOpaque(false);
        dxModeVal.setFocusable(false);
        add(dxModeVal,0);

        configButton.setBounds(30, 130, 80, 20);
        ...
        exitButton.setBounds(180, 130, 80, 20);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == configButton) {
            ...
            String lang = Language.getLang((String) langLableVal.getSelectedItem());
            String dx = (String) dxModeVal.getSelectedItem();
            if(isFFXIVFloder(path)){
                Config.setProperty("GamePath", path);
                Config.setProperty("Language", lang);
                Config.setProperty("DXMode", dx);
                Config.saveProperty();
